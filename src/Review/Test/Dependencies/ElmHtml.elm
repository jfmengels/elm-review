...
"""
              , tipe =
                    Elm.Type.Lambda
                        ...
                        (Elm.Type.Type "Html.Attribute" [ Elm.Type.Var "msg" ])
              }
            , { name = "cols"
...
"""
              , tipe =
                    Elm.Type.Lambda (Elm.Type.Type "String.String" [])
                        (Elm.Type.Lambda
                            (Elm.Type.Type "Json.Decode.Decoder"
                                [ Elm.Type.Record
                                    [ ( "message", Elm.Type.Var "msg" )
                                    , ( "stopPropagation", Elm.Type.Type "Basics.Bool" [] )
                                    , ( "preventDefault", Elm.Type.Type "Basics.Bool" [] )
                                    ]
                                    Nothing
                                ]
                            )
...
"""
              , tipe =
                    Elm.Type.Lambda (Elm.Type.Type "String.String" [])
                        (Elm.Type.Lambda (Elm.Type.Type "List.List" [ Elm.Type.Type "Html.Attribute" [ Elm.Type.Var "msg" ] ])
                            (Elm.Type.Lambda
                                (Elm.Type.Type "List.List"
                                    [ Elm.Type.Tuple
                                        [ Elm.Type.Type "String.String" []
                                        , Elm.Type.Type "Html.Html" [ Elm.Type.Var "msg" ]
                                        ]
                                    ]
                                )
                                (Elm.Type.Type "Html.Html" [ Elm.Type.Var "msg" ])
