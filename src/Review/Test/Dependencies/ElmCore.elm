...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Type "Array.Array" [ Elm.Type.Var "a" ]) (Elm.Type.Type "List.List" [ Elm.Type.Tuple [ Elm.Type.Type "Basics.Int" []
    , Elm.Type.Var "a" ] ])
    }
    , { name = "toList"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Tuple [ Elm.Type.Type "Basics.Float" []
    , Elm.Type.Type "Basics.Float" [] ]) (Elm.Type.Tuple [ Elm.Type.Type "Basics.Float" []
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "comparable"
    , Elm.Type.Var "a" ]) (Elm.Type.Lambda (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "comparable"
    , Elm.Type.Var "b" ]) (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "comparable"
    , Elm.Type.Var "a" ]))
    }
    , { name = "empty"
    , comment = " Create an empty dictionary. "
    , tipe = Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "k"
    , Elm.Type.Var "v" ]
    }
    , { name = "filter"
    , comment = " Keep only the key-value pairs that pass the given test. "
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "comparable") (Elm.Type.Lambda (Elm.Type.Var "v") (Elm.Type.Type "Basics.Bool" []))) (Elm.Type.Lambda (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "comparable"
    , Elm.Type.Var "v" ]) (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "comparable"
    , Elm.Type.Var "v" ]))
    }
    , { name = "foldl"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "k") (Elm.Type.Lambda (Elm.Type.Var "v") (Elm.Type.Lambda (Elm.Type.Var "b") (Elm.Type.Var "b")))) (Elm.Type.Lambda (Elm.Type.Var "b") (Elm.Type.Lambda (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "k"
    , Elm.Type.Var "v" ]) (Elm.Type.Var "b")))
    }
    , { name = "foldr"
...
"""
    ...
    , tipe = Elm.Type.Lambda (Elm.Type.Type "List.List" [ Elm.Type.Tuple [ Elm.Type.Var "comparable"
    , Elm.Type.Var "v" ] ]) (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "comparable"
    , Elm.Type.Var "v" ])
    }
    , { name = "get"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Var "comparable") (Elm.Type.Lambda (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "comparable"
    , Elm.Type.Var "v" ]) (Elm.Type.Type "Maybe.Maybe" [ Elm.Type.Var "v" ]))
    }
    , { name = "insert"
    , comment = """ Insert a key-value pair into a dictionary. Replaces value when there is
a collision. """
    , tipe = Elm.Type.Lambda (Elm.Type.Var "comparable") (Elm.Type.Lambda (Elm.Type.Var "v") (Elm.Type.Lambda (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "comparable"
    , Elm.Type.Var "v" ]) (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "comparable"
    , Elm.Type.Var "v" ])))
    }
    , { name = "intersect"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "comparable"
    , Elm.Type.Var "v" ]) (Elm.Type.Lambda (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "comparable"
    , Elm.Type.Var "v" ]) (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "comparable"
    , Elm.Type.Var "v" ]))
    }
    , { name = "isEmpty"
    ...
    isEmpty empty == True
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "k"
    , Elm.Type.Var "v" ]) (Elm.Type.Type "Basics.Bool" [])
    }
    , { name = "keys"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "k"
    , Elm.Type.Var "v" ]) (Elm.Type.Type "List.List" [ Elm.Type.Var "k" ])
    }
    , { name = "map"
    , comment = """ Apply a function to all values in a dictionary.
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "k") (Elm.Type.Lambda (Elm.Type.Var "a") (Elm.Type.Var "b"))) (Elm.Type.Lambda (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "k"
    , Elm.Type.Var "a" ]) (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "k"
    , Elm.Type.Var "b" ]))
    }
    , { name = "member"
...
you want.
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "comparable") (Elm.Type.Lambda (Elm.Type.Var "a") (Elm.Type.Lambda (Elm.Type.Var "result") (Elm.Type.Var "result")))) (Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "comparable") (Elm.Type.Lambda (Elm.Type.Var "a") (Elm.Type.Lambda (Elm.Type.Var "b") (Elm.Type.Lambda (Elm.Type.Var "result") (Elm.Type.Var "result"))))) (Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "comparable") (Elm.Type.Lambda (Elm.Type.Var "b") (Elm.Type.Lambda (Elm.Type.Var "result") (Elm.Type.Var "result")))) (Elm.Type.Lambda (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "comparable"
    , Elm.Type.Var "a" ]) (Elm.Type.Lambda (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "comparable"
    , Elm.Type.Var "b" ]) (Elm.Type.Lambda (Elm.Type.Var "result") (Elm.Type.Var "result"))))))
    }
    , { name = "partition"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "comparable") (Elm.Type.Lambda (Elm.Type.Var "v") (Elm.Type.Type "Basics.Bool" []))) (Elm.Type.Lambda (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "comparable"
    , Elm.Type.Var "v" ]) (Elm.Type.Tuple [ Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "comparable"
    , Elm.Type.Var "v" ]
    , Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "comparable"
    , Elm.Type.Var "v" ] ]))
    }
    , { name = "remove"
...
no changes are made. """
    ...
    , tipe = Elm.Type.Lambda (Elm.Type.Var "comparable") (Elm.Type.Lambda (Elm.Type.Var "v") (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "comparable"
    , Elm.Type.Var "v" ]))
    }
    , { name = "size"
    , comment = " Determine the number of key-value pairs in the dictionary. "
    , tipe = Elm.Type.Lambda (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "k"
    , Elm.Type.Var "v" ]) (Elm.Type.Type "Basics.Int" [])
    }
    , { name = "toList"
    , comment = " Convert a dictionary into an association list of key-value pairs, sorted by keys. "
    , tipe = Elm.Type.Lambda (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "k"
    , Elm.Type.Var "v" ]) (Elm.Type.Type "List.List" [ Elm.Type.Tuple [ Elm.Type.Var "k"
    , Elm.Type.Var "v" ] ])
    }
    , { name = "union"
...
"""
    ...
    , tipe = Elm.Type.Lambda (Elm.Type.Var "comparable") (Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Type "Maybe.Maybe" [ Elm.Type.Var "v" ]) (Elm.Type.Type "Maybe.Maybe" [ Elm.Type.Var "v" ])) (Elm.Type.Lambda (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "comparable"
    , Elm.Type.Var "v" ]) (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "comparable"
    , Elm.Type.Var "v" ])))
    }
    , { name = "values"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Type "Dict.Dict" [ Elm.Type.Var "k"
    , Elm.Type.Var "v" ]) (Elm.Type.Type "List.List" [ Elm.Type.Var "v" ])
    } ]
    }
    , { name = "List"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "a") (Elm.Type.Type "Basics.Bool" [])) (Elm.Type.Lambda (Elm.Type.Type "List.List" [ Elm.Type.Var "a" ]) (Elm.Type.Tuple [ Elm.Type.Type "List.List" [ Elm.Type.Var "a" ]
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Type "List.List" [ Elm.Type.Tuple [ Elm.Type.Var "a"
    , Elm.Type.Var "b" ] ]) (Elm.Type.Tuple [ Elm.Type.Type "List.List" [ Elm.Type.Var "a" ]
...
"""
    ...
    , binops = []
    , values = [ { name = "sendToApp"
    , comment = """ Send the router a message for the main loop of your app. This message will
be handled by the overall `update` function, just like events from `Html`.
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Type "Platform.Router" [ Elm.Type.Var "msg"
    , Elm.Type.Var "a" ]) (Elm.Type.Lambda (Elm.Type.Var "msg") (Elm.Type.Type "Platform.Task" [ Elm.Type.Var "x"
    , Elm.Type.Tuple [] ]))
    }
    , { name = "sendToSelf"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Type "Platform.Router" [ Elm.Type.Var "a"
    , Elm.Type.Var "msg" ]) (Elm.Type.Lambda (Elm.Type.Var "msg") (Elm.Type.Type "Platform.Task" [ Elm.Type.Var "x"
    , Elm.Type.Tuple [] ]))
    }
    , { name = "worker"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Record [ ( "init", Elm.Type.Lambda (Elm.Type.Var "flags") (Elm.Type.Tuple [ Elm.Type.Var "model"
    , Elm.Type.Type "Platform.Cmd.Cmd" [ Elm.Type.Var "msg" ] ]) )
    , ( "update", Elm.Type.Lambda (Elm.Type.Var "msg") (Elm.Type.Lambda (Elm.Type.Var "model") (Elm.Type.Tuple [ Elm.Type.Var "model"
    , Elm.Type.Type "Platform.Cmd.Cmd" [ Elm.Type.Var "msg" ] ])) )
    , ( "subscriptions", Elm.Type.Lambda (Elm.Type.Var "model") (Elm.Type.Type "Platform.Sub.Sub" [ Elm.Type.Var "msg" ]) ) ] Nothing) (Elm.Type.Type "Platform.Program" [ Elm.Type.Var "flags"
    , Elm.Type.Var "model"
    , Elm.Type.Var "msg" ])
    } ]
    }
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Type "Process.Id" []) (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Tuple [] ])
    }
    , { name = "sleep"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Type "Basics.Float" []) (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Tuple [] ])
    }
    , { name = "spawn"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ]) (Elm.Type.Type "Task.Task" [ Elm.Type.Var "y"
...
code.
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "a") (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "b" ])) (Elm.Type.Lambda (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ]) (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "b" ]))
    }
    , { name = "fromMaybe"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Var "x") (Elm.Type.Lambda (Elm.Type.Type "Maybe.Maybe" [ Elm.Type.Var "a" ]) (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ]))
    }
    , { name = "map"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "a") (Elm.Type.Var "value")) (Elm.Type.Lambda (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ]) (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "value" ]))
    }
    , { name = "map2"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "a") (Elm.Type.Lambda (Elm.Type.Var "b") (Elm.Type.Var "value"))) (Elm.Type.Lambda (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ]) (Elm.Type.Lambda (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "b" ]) (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "value" ])))
    }
    , { name = "map3"
    , comment = ""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "a") (Elm.Type.Lambda (Elm.Type.Var "b") (Elm.Type.Lambda (Elm.Type.Var "c") (Elm.Type.Var "value")))) (Elm.Type.Lambda (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ]) (Elm.Type.Lambda (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "b" ]) (Elm.Type.Lambda (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "c" ]) (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "value" ]))))
    }
    , { name = "map4"
    , comment = ""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "a") (Elm.Type.Lambda (Elm.Type.Var "b") (Elm.Type.Lambda (Elm.Type.Var "c") (Elm.Type.Lambda (Elm.Type.Var "d") (Elm.Type.Var "value"))))) (Elm.Type.Lambda (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ]) (Elm.Type.Lambda (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "b" ]) (Elm.Type.Lambda (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "c" ]) (Elm.Type.Lambda (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "d" ]) (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "value" ])))))
    }
    , { name = "map5"
    , comment = ""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "a") (Elm.Type.Lambda (Elm.Type.Var "b") (Elm.Type.Lambda (Elm.Type.Var "c") (Elm.Type.Lambda (Elm.Type.Var "d") (Elm.Type.Lambda (Elm.Type.Var "e") (Elm.Type.Var "value")))))) (Elm.Type.Lambda (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ]) (Elm.Type.Lambda (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "b" ]) (Elm.Type.Lambda (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "c" ]) (Elm.Type.Lambda (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "d" ]) (Elm.Type.Lambda (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "e" ]) (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "value" ]))))))
    }
    , { name = "mapError"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "x") (Elm.Type.Var "y")) (Elm.Type.Lambda (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ]) (Elm.Type.Type "Result.Result" [ Elm.Type.Var "y"
    , Elm.Type.Var "a" ]))
    }
    , { name = "toMaybe"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ]) (Elm.Type.Type "Maybe.Maybe" [ Elm.Type.Var "a" ])
    }
    , { name = "withDefault"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Var "a") (Elm.Type.Lambda (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ]) (Elm.Type.Var "a"))
    } ]
    }
    , { name = "Set"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "comparable") (Elm.Type.Type "Basics.Bool" [])) (Elm.Type.Lambda (Elm.Type.Type "Set.Set" [ Elm.Type.Var "comparable" ]) (Elm.Type.Tuple [ Elm.Type.Type "Set.Set" [ Elm.Type.Var "comparable" ]
...
pattern match on strings exactly as you would with lists.
    ...
    uncons \"\"    == Nothing
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Type "String.String" []) (Elm.Type.Type "Maybe.Maybe" [ Elm.Type.Tuple [ Elm.Type.Type "Char.Char" []
...
"""
    , tipe = Elm.Type.Type "Platform.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ]
    } ]
    , unions = []
    , binops = []
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "a") (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "b" ])) (Elm.Type.Lambda (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ]) (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "b" ]))
    }
    , { name = "attempt"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Type "Result.Result" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ]) (Elm.Type.Var "msg")) (Elm.Type.Lambda (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ]) (Elm.Type.Type "Platform.Cmd.Cmd" [ Elm.Type.Var "msg" ]))
    }
    , { name = "fail"
...
used with `andThen` to check on the outcome of another task.
    ...
    notFound =
      fail NotFound
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Var "x") (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ])
    }
    , { name = "map"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "a") (Elm.Type.Var "b")) (Elm.Type.Lambda (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ]) (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "b" ]))
    }
    , { name = "map2"
...
[time]: /packages/elm/time/latest/
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "a") (Elm.Type.Lambda (Elm.Type.Var "b") (Elm.Type.Var "result"))) (Elm.Type.Lambda (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ]) (Elm.Type.Lambda (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "b" ]) (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "result" ])))
    }
    , { name = "map3"
    , comment = ""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "a") (Elm.Type.Lambda (Elm.Type.Var "b") (Elm.Type.Lambda (Elm.Type.Var "c") (Elm.Type.Var "result")))) (Elm.Type.Lambda (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ]) (Elm.Type.Lambda (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "b" ]) (Elm.Type.Lambda (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "c" ]) (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "result" ]))))
    }
    , { name = "map4"
    , comment = ""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "a") (Elm.Type.Lambda (Elm.Type.Var "b") (Elm.Type.Lambda (Elm.Type.Var "c") (Elm.Type.Lambda (Elm.Type.Var "d") (Elm.Type.Var "result"))))) (Elm.Type.Lambda (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ]) (Elm.Type.Lambda (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "b" ]) (Elm.Type.Lambda (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "c" ]) (Elm.Type.Lambda (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "d" ]) (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "result" ])))))
    }
    , { name = "map5"
    , comment = ""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "a") (Elm.Type.Lambda (Elm.Type.Var "b") (Elm.Type.Lambda (Elm.Type.Var "c") (Elm.Type.Lambda (Elm.Type.Var "d") (Elm.Type.Lambda (Elm.Type.Var "e") (Elm.Type.Var "result")))))) (Elm.Type.Lambda (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ]) (Elm.Type.Lambda (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "b" ]) (Elm.Type.Lambda (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "c" ]) (Elm.Type.Lambda (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "d" ]) (Elm.Type.Lambda (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "e" ]) (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "result" ]))))))
    }
    , { name = "mapError"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "x") (Elm.Type.Var "y")) (Elm.Type.Lambda (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ]) (Elm.Type.Type "Task.Task" [ Elm.Type.Var "y"
    , Elm.Type.Var "a" ]))
    }
    , { name = "onError"
...
callback to recover.
    ...
    succeed 9
      ...
      -- succeed 9
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "x") (Elm.Type.Type "Task.Task" [ Elm.Type.Var "y"
    , Elm.Type.Var "a" ])) (Elm.Type.Lambda (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ]) (Elm.Type.Type "Task.Task" [ Elm.Type.Var "y"
    , Elm.Type.Var "a" ]))
    }
...
[guide]: https://guide.elm-lang.org/
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "a") (Elm.Type.Var "msg")) (Elm.Type.Lambda (Elm.Type.Type "Task.Task" [ Elm.Type.Type "Basics.Never" []
    , Elm.Type.Var "a" ]) (Elm.Type.Type "Platform.Cmd.Cmd" [ Elm.Type.Var "msg" ]))
    }
    , { name = "sequence"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Type "List.List" [ Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ] ]) (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Type "List.List" [ Elm.Type.Var "a" ] ])
    }
    , { name = "succeed"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Var "a") (Elm.Type.Type "Task.Task" [ Elm.Type.Var "x"
    , Elm.Type.Var "a" ])
    } ]
    }
    , { name = "Tuple"
...
"""
    ...
    first (\"john\", \"doe\") == \"john\"
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Tuple [ Elm.Type.Var "a"
    , Elm.Type.Var "b" ]) (Elm.Type.Var "a")
    }
    , { name = "mapBoth"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "a") (Elm.Type.Var "x")) (Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "b") (Elm.Type.Var "y")) (Elm.Type.Lambda (Elm.Type.Tuple [ Elm.Type.Var "a"
    , Elm.Type.Var "b" ]) (Elm.Type.Tuple [ Elm.Type.Var "x"
    , Elm.Type.Var "y" ])))
    }
    , { name = "mapFirst"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "a") (Elm.Type.Var "x")) (Elm.Type.Lambda (Elm.Type.Tuple [ Elm.Type.Var "a"
    , Elm.Type.Var "b" ]) (Elm.Type.Tuple [ Elm.Type.Var "x"
    , Elm.Type.Var "b" ]))
    }
    , { name = "mapSecond"
...
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Lambda (Elm.Type.Var "b") (Elm.Type.Var "y")) (Elm.Type.Lambda (Elm.Type.Tuple [ Elm.Type.Var "a"
    , Elm.Type.Var "b" ]) (Elm.Type.Tuple [ Elm.Type.Var "a"
    , Elm.Type.Var "y" ]))
    }
    , { name = "pair"
    ...
    zip xs ys =
      List.map2 Tuple.pair xs ys
"""
    , tipe = Elm.Type.Lambda (Elm.Type.Var "a") (Elm.Type.Lambda (Elm.Type.Var "b") (Elm.Type.Tuple [ Elm.Type.Var "a"
    , Elm.Type.Var "b" ]))
    }
    , { name = "second"
