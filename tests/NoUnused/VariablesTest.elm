...
a = B.b"""
    ...
    , test "foo" <|
        \() ->
            [ """module Humio.Page.RepoOrView.Packages.Installed.SelectedPackage exposing (packageTypePostfix)

import Humio.Domain.Package.Type as PackageType
import Humio.Api.Enum.PackageType as PackageType

packageTypePostfix : Model -> String
packageTypePostfix model =
   case model.packageType of
       PackageType.Library ->
           PackageType.toDisplayString model.packageType

       PackageType.Application ->
           ""
"""
            , """module Humio.Domain.Package.Type exposing
    ( PackageType
    , toDisplayString
    )
...
toDisplayString : PackageType -> String
toDisplayString packageType =
    case packageType of
        PackageType.Application ->
            "Application"
...
module Humio.Api.Enum.PackageType exposing (..)
