    ...
    ProjectContext
        ...
        , moduleInformationDict =
            ModuleInformation.singleton moduleName
                { values = List.map (Value.relateToModule moduleName) <| Debug.log "modulevalues" moduleContext.moduleValues
                }
        }
    ...
    case Node.value node of
        Declaration.FunctionDeclaration function ->
            ...
            [ Value.create
                ...
                |> Debug.log "take value from function"
            ]
...
typeAnnotationToElmType moduleNameLookupTable node =
    case Node.value node of
        ...
        TypeAnnotation.Typed (Node typeRange ( rawModuleName, name )) nodes ->
            case Debug.log "real module name" <| ModuleNameLookupTable.moduleNameAt moduleNameLookupTable typeRange of
                Just moduleName ->
