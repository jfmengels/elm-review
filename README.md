...
Check out the [`Review.Rule`](https://package.elm-lang.org/packages/jfmengels/elm-review/2.16.0/Review-Rule/) documentation for how to get started.
...
You can [configure exceptions](https://package.elm-lang.org/packages/jfmengels/elm-review/2.16.0/Review-Rule/#configuring-exceptions),
...
[`Rule.withDataExtractor`](https://package.elm-lang.org/packages/jfmengels/elm-review/2.16.0/Review-Rule/#withDataExtractor).
